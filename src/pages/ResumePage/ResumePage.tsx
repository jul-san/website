    ...
    return(
        <>
            ...
            <Container>
                ...
                <Section name="Florida State University" position='Bachelor of Science in Computer Science' date='Expected Graduation May 2026' img='src/img/fsu-logo.png'/>
                ...
                <Section name="DeVoe L. Moore Center" position="Data Analytics Intern" date='January 2024 - may 2024' img='src/img/devoe.png'></Section>
                <Section name="Northrop Grumman" position='Software Engineer Intern' date='May 2023 - July 2023' img='src/img/ng-logo.png'/>
                ...
                <Section name="The Torch Society" position='Spark' date='January 2024 - Present' img='src/img/torch.png'/>
